    ...
    <div className="grid md:grid-cols-2 gap-16 items-center">
      ...
      <div>
        ...
        <div className="mt-10 space-y-5">
          {[
            ...
            >
              <div className="flex items-center justify-center min-w-[28px] h-7 rounded-full bg-gradient-to-r from-cyan-400 to-indigo-500 shadow-md">
      ...
      <div className="relative">
        ...
        <div className="relative rounded-[35px] overflow-hidden border border-white/40 bg-white/40 backdrop-blur-xl shadow-[0_25px_80px_rgba(0,0,0,0.15)] p-3">
          ...
          {/* Floating Card */}
          <div className="absolute bottom-6 left-6 bg-white rounded-2xl shadow-xl px-6 py-4 border border-slate-100">
            <p className="text-sm text-slate-500">
              Trusted by Clients
            </p>

            <h4 className="text-2xl font-bold bg-gradient-to-r from-cyan-500 to-indigo-600 bg-clip-text text-transparent">
              500+ Projects
            </h4>
          </div>
        </div>
