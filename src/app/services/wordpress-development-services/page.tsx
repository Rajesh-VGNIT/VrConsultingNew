...
export async function generateMetadata() {
  ...
  return pageMetadata["wordpress-development-services"];
}
      ...
      <div className="container mx-auto  py-12 space-y-16">
        ...
        <div data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {section.whyChooseWordPress.map((item: any, i: number) => (
              <div data-aos="fade-up"
                key={i}
        ...
        <div data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {section.WordPressDevelopmentService.map((item: any, i: number) => (
              <div data-aos="fade-up"
                key={i}
                className="group relative overflow-hidden rounded-[32px] bg-white border border-slate-200 p-8 transition-all duration-900  hover:shadow-[0_20px_60px_rgba(99,102,241,0.18)]"
              >
        ...
        {data?.WordPressDevelopment?.WebsiteMigrationUpgrades?.map((legacy: any, index: number) => (
