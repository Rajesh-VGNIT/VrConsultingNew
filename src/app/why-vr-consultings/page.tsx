  ...
  return (
    <>
      ...
      <div className="mx-auto container space-y-8 py-12">
        ...
        {/* Top Section */}
        {whyVR && (
          <div data-aos="fade-up" className="grid items-center gap-16 md:grid-cols-2">

            {/* Left Images */}
            <div data-aos="fade-up" className="relative flex justify-start">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          {/* Mission */}
          {mission && (
            <div data-aos="fade-up" className="group relative overflow-hidden rounded-[32px] bg-white border border-slate-200 p-8 transition-all duration-900  hover:shadow-[0_20px_60px_rgba(99,102,241,0.18)]">
              {/* Top Gradient Glow */}
              <div className="absolute -top-16 -right-16 w-40 h-40 bg-cyan-100 rounded-full blur-3xl opacity-50"></div>
              <div className="absolute -bottom-16 -left-16 w-40 h-40 bg-fuchsia-100 rounded-full blur-3xl opacity-50"></div>
