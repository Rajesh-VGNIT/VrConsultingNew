...
const featuresData: Feature[] = [
  {
    id: 1,
    icon: "/images/features/output-onlinepngtools1.png",
  ...
  {
    id: 2,
    icon: "/images/features/output-onlinepngtools2.png",
  ...
  {
    id: 3,
    icon: "/images/features/output-onlinepngtools3.png",
  ...
  {
    id: 4,
    icon: "/images/features/output-onlinepngtools4.png",
  ...
  {
    id: 5,
    icon: "/images/features/output-onlinepngtools5.png",
  ...
  {
    id: 6,
    icon: "/images/features/output-onlinepngtools6.png",
  ...
  button: { 
    ...
    {
    id: 7,
    icon: "/images/features/output-onlinepngtools7.png",
  ...
  button: { 
    ...
    {
    id: 8,
    icon: "/images/features/output-onlinepngtools8.png",
    title: "Web Hosting",
    paragraph:
      "We are developing software products and web applications according to your need. It's a best way to convert in mobile applications.....",
  button: { 
